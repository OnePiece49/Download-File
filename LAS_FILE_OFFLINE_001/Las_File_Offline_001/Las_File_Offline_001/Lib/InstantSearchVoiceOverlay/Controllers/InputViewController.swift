...
class InputViewController: UIViewController {
  ...
  let recordingButton = RecordingButton()
    ...
    private lazy var searchButton: UIButton = {
        ...
        button.setDimensions(width: 100, height: 34)
  ...
  override func viewDidLoad() {
    ...
    let subViews = [titleLabel, subtitleLabel, subtitleBulletLabel, closeButton, recordingButton, tryAgainLabel, searchButton]
    ...
    ViewHelpers.setConstraintsForTryAgainLabel(tryAgainLabel, recordingButton, margins, "", constants.textColor)
      ...
      NSLayoutConstraint.activate([
        searchButton.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -180),
        searchButton.rightAnchor.constraint(equalTo: view.centerXAnchor, constant: -64),
        
        closeButton.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -180),
        closeButton.leftAnchor.constraint(equalTo: view.centerXAnchor, constant: 64),
      ])

      
    let tap = UITapGestureRecognizer(target: self, action: #selector(self.closeButtonTapped))
...
//  }
  ...
  @objc func closeButtonTapped() {
    ...
    @objc func handleSearchButtonTapped() {
        ...
        print("DEBUG: \(String(describing: delegate))")
