...
public enum FileType: String {
	...
	case cab // compress
	case cr2 // photo
	case crx // cha lien quan
	case deb // cha lien quan
	case dmg // cha lien quan
	case eot // font
	case epub // docx
	case exe // cha lien quan
	case flac // audio
	case flif // photo
	case flv // video
	case gif // photo
	...
	case mp4 // video
	case mpg // video
	case msi // cha lien quan
	case mxf // video
	case nes // cha lien quan
	case ogg // compress
	case opus // audio
	case otf // font
	case pdf // docx
...
public struct MimeType {
	...
	public let matches: ([UInt8], Swime) -> Bool
  ...
  public static let all: [MimeType] = [
    ...
    MimeType(
        ...
        bytesCount: 6,
        matches: { bytes, _ in
            return bytes[0...5] == [0x50, 0x4B, 0x03, 0x04, 0x14, 0x00]
        }
    ),
    MimeType(
      mime: "image/jpeg",
